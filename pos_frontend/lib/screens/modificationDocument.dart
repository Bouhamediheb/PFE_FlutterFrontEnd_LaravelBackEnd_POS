...
class modificationDocument extends StatefulWidget {
  int documentId;
  modificationDocument(this.documentId);

  @override
  State<modificationDocument> createState() => _modificationDocumentState();
}

String dropdownvalue = "Bon de Commande";
String dropdownvalue2 = "Fournisseur 1";

class _modificationDocumentState extends State<modificationDocument> {
  ...
  Future<http.Response> modificationDocument(int id, int typeDocument,
      String numeroDocument, String dateDocument, String totalDocument) async {
    List documents = [];
